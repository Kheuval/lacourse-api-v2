 ...
 */
final class Version20230628180508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, servings INT NOT NULL, total_time INT NOT NULL, preparation_time INT DEFAULT NULL, rest_time INT DEFAULT NULL, cooking_time INT DEFAULT NULL, verified TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_DA88B1375E237E06 (name), INDEX IDX_DA88B1373DA5256D (image_id), INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
